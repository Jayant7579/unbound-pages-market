...
import { ArrowLeft, BookOpen, Eye, EyeOff, Mail, Lock, User } from "lucide-react";
            ...
            <CardHeader className="text-center">
              ...
              <CardDescription>
                {isLogin 
                  ...
                  : "Join thousands of book lovers on BookVerse"
                }
              </CardDescription>
            </CardHeader>
            ...
            <CardFooter className="text-center">
              <div className="w-full text-sm text-gray-600">
                ...
                <Button 
                  variant="link" 
                  onClick={switchMode}
                  className="text-purple-600 hover:text-purple-800 p-0 h-auto font-normal"
                >
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 text-gray-500">
                  Or continue with
                </span>
              </div>
            </div>
